...
## Workflow
1. Identify a relevant URL for the topic
2. Use `web_fetch` to get the page content
3. Analyze and extract relevant information
4. Save key findings to memory if useful long-term
